...
* Use commands:
python word2vec_model_loading_v1.py --train_data=cleaned_data/sample_train_data.txt --eval_data=questions-words.txt --save_path=./sample_output/run2/
python sample_word2vec_model_loading.py --train_data=cleaned_data/sample_train_data.txt --eval_data=questions-words.txt --save_path=./sample_output/run2 --use=True --interactive=True
